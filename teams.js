...
const teams = [
  ...
  },
  {
    ...
    description: "С 3 января 2026 года эта команда начала свою историю. Команда регулярно участвует в чемпионатах и занимает призовые места. Организация Bedlam подписала состав 13 июля 2026 года.",
    activeRoster: [
